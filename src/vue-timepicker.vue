...
<span class="time-picker">
  <input class="display-time boxshadow1 form-control form-control-big input-icon input-icon-time" :id="id" v-model="displayTime" @click.stop="toggleDropdown" type="text" readonly />
